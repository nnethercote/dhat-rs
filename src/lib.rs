...
//!   Allocated at {
//!     #1: 0x100d3ebb8: <alloc::alloc::Global as core::alloc::AllocRef>::alloc (alloc.rs:203:9)
//!     #2: 0x100d3ebb8: alloc::raw_vec::RawVec<T,A>::allocate_in (raw_vec.rs:186:45)
//!     #3: 0x100d3ebb8: alloc::raw_vec::RawVec<T,A>::with_capacity_in (raw_vec.rs:161:9)
//!     #4: 0x100d3ebb8: alloc::raw_vec::RawVec<T>::with_capacity (raw_vec.rs:92:9)
//!     #5: 0x100d3ebb8: alloc::vec::Vec<T>::with_capacity (vec.rs:355:20)
//!     #6: 0x100d3ebb8: std::io::buffered::BufWriter<W>::with_capacity (buffered.rs:517:46)
//!     #7: 0x100d3ebb8: std::io::buffered::LineWriter<W>::with_capacity (buffered.rs:925:29)
//!     #8: 0x100d3ebb8: std::io::buffered::LineWriter<W>::new (buffered.rs:905:9)
//!     #9: 0x100d3ebb8: std::io::stdio::stdout::stdout_init (stdio.rs:543:65)
//!     #10: 0x100d3ebb8: std::io::lazy::Lazy<T>::init (lazy.rs:57:19)
//!     #11: 0x100d3ebb8: std::io::lazy::Lazy<T>::get (lazy.rs:33:18)
//!     #12: 0x100d3ebb8: std::io::stdio::stdout (stdio.rs:536:25)
//!     #13: 0x100d3f77b: std::io::stdio::print_to::{{closure}} (stdio.rs:890:13)
//!     #14: 0x100d3f77b: std::thread::local::LocalKey<T>::try_with (local.rs:265:16)
//!     #15: 0x100d3f77b: std::io::stdio::print_to (stdio.rs:879:18)
//!     #16: 0x100d3f77b: std::io::stdio::_print (stdio.rs:907:5)
//!     #17: 0x100c2ef06: allocs::main (allocs.rs:9:5)
//!     #18: 0x100c2ec6e: core::ops::function::FnOnce::call_once (function.rs:227:5)
//!     #19: 0x100c2f0c1: std::sys_common::backtrace::__rust_begin_short_backtrace (backtrace.rs:137:18)
//!     #20: 0x100c2ee24: std::rt::lang_start::{{closure}} (rt.rs:66:18)
//!   }
//! }
//! ```
